...
MODEL_CONTEXT_LIMITS = {
    ...
    "gpt-4": 8192,
    "gpt-3.5-turbo": 16384,
    "claude-3-5-sonnet-20240620": float('inf'),
    "gemini-1.5-pro": float('inf'),
    "DeepSeek-Coder-V2": float('inf'),
    "deepseek-V2-chat": float('inf')
}
...
def count_tokens(message, encoding):
    if encoding is None:
        return 0  # Return 0 for models without tokenization
    try:
