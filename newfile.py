...
def count_tokens(message, model):
    ...
    try:
        ...
        elif model in ["claude-3-5-sonnet-20240620", "gemini-1.5-pro", "DeepSeek-Coder-V2", "deepseek-V2-chat"]:
            # For non-OpenAI models, use a more sophisticated approximation
            # This method splits on whitespace and punctuation, which is closer to how most tokenizers work
            return len(re.findall(r'\w+|[^\w\s]', message))
        else:
